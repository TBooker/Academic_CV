...
\begin{outerlist}
	...
	\item[] Computer skills
		\begin{innerlist}
		\item[] Scripting: Python, R and Bash as well as a little bit of C and Perl
		\item[] OS: Ubuntu, Windows, Mac OSX
		\item[] Various: Grid Engine clustering systems, git, emacs, ssh/scp, tmux, Microsoft Office
		\end{innerlist}
		
	\item[] Science communication, both written and verbal.
...
\begin{outerlist}
	...
	\item[] I have reviewed articles for the following journals:
		\begin{innerlist}
			\item[] \emph{Ecology and Evolution}, \emph{Science}
		\end{innerlist}
...
\begin{bibsection}
    ...
    \item {\bf Booker, T. R.}, \& Keightley, P. D. (\emph{In preparation}). ``Understanding the forces that shape patterns of genetic diversity in the genome of wild house mice, \emph{Mus musculus castaneus}."
    
   \item {\bf Booker, T. R.}, Jackson, B. C., \& Keightley, P. D. (\emph{In press}). ``Detecting positive selection in the genome." \emph{BMC Biology}. 
...
\emph{Selective sweeps and background selection in the genome of wild house mice,} Mus musculus castaneus (Poster - \emph{Runner up best student poster}) \\
...
\item \emph{Finalist}, Environment Yes! \hfill Sept 2016
...
\item[] Supervision \hfill 2016\\
	\emph{I have provided co-supervision to masters and honours students}\\
\item[] Statistics and Data Analysis, MSc course \hfill 2014-2017\\
	\emph{Demonstrating in computer practical sessions and running tutorial sessions on probability theory and statistical analysis}\\
\item[] Population and Quantitative Genetics, MSc course \hfill 2015-2017 \\    
	\emph{Running tutorial sessions on population genetic theory}\\
\item[] Ecology and Evolutionary Genetics, BSc course \hfill 2014-2015\\
	\emph{Demonstrating in computer practical sessions on evolutionary biology}
...
Aside from evolutionary biology I have several hobbies that I try and find time for. I enjoy playing guitar, woodworking (particularly woodturning), helping out around my parents' farm, hill-walking and playing classic point-and-click adventure games.
