...
<<<<<<< HEAD
	\item[] Bioinformatics: 
		...
		\item[] Statistical Analysis: 
			\begin{innerlist}
			\item[] Including: Linear, non-linear and mixed models, parametric and non-parametric statistics and maximium likelihood estimation.
			\end{innerlist}
...
<<<<<<< HEAD
	\item[] I have reviewed articles for the following journals:
		...
		\end{innerlist}
	\item[] I started and organised a journal club on classic population genetic papers at the University of Edinburgh in 2017
...
\begin{bibsection}
    ...
    \item {\bf Booker, T. R.}, \& Keightley, P. D. (\emph{Accepted}). ``Understanding the factors that shape patterns of nucleotide diversity in the house mouse genome". \emph{Molecular Biology and Evolution}
=======
...
<<<<<<< HEAD
    ...
    \item {\bf Booker, T. R.}, Jackson, B. Craig, R. Charlesworth, B. \& Keightley, P. D. (\emph{In preparation}). ``Estimating parameters of strong positive selection from patterns of genetic diversity in house mice"
\end{itemize}
...
<<<<<<< HEAD
	\item[] I have reviewed articles for the following journals:
		\begin{innerlist}
			\item[] \emph{PLoS Genetics}, \emph{Molecular Biology and Evolution}, \emph{Molecular Ecology}, \emph{Genome Biology and Evolution}, \emph{Ecology and Evolution}, \emph{Frontiers in Zoology}
		\end{innerlist}
=======
\vspace{.1275in}
...
<<<<<<< HEAD
\tab S-A. Xerri - Master's project - \emph{Now PhD student at the Max Planck Institute}\\
\tab C. Barata - Master's project - \emph{Now PhD student at the University of St. Andrews}\\
\tab B. Lecher - Honour's project - \emph{Now MSc student at Université Claude Bernard}\\
...
{\bf January 2018} - Population Genetics Group 51, Bristol, UK (Oral Presentation) \\
